...
instructor: ["Rob Lane (Unix)", "Eric Glass (R day 1)", "Satwinder Singh (Git)", "Wei Yin (R day 2)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Tameek Henderson", "Aaron Tran", "Alan Crosswell", "Moacir P de Sa Pereira", "Axinia Radeva", "Robert Kudyba", "Eric Glass", "Wei Yin", "Esther Jackson", "John Villa"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
